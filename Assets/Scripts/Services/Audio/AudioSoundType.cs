...
namespace digectsoft
{
	...
	{
		SOUND_ATTACK = EffectType.ATTACK,
		SOUND_SHIELD = EffectType.SHIELD,
		SOUND_REGENERATION = EffectType.REGENERATION,
		SOUND_FIREBALL = EffectType.FIREBALL,
		SOUND_CLEANUP = EffectType.CLEANUP,
		SOUND_HIT
	}
}
